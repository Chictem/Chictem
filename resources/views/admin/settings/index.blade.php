...
@section('page_header')
    <h1 class="page-title">
        <i class="voyager-settings"></i> {{ trans('admin.setting.name') }}
    </h1>
@stop
...
@section('content')
    ...
    <div class="container-fluid">
        <div class="alert alert-info">
            <p>{!! trans('admin.setting.message.use', ['usage' => "<code>Voyager::setting('key')</code>"]) !!} </p>
        </div>
    </div>
                ...
                @foreach($settings as $setting)
                    ...
                    <div class="panel-body">
                        ...
                        @elseif($setting->type == "select_dropdown")
                            @php $options = json_decode($setting->details); @endphp
                            @php $selected_value = (isset($setting->value) && ! empty($setting->value)) ? $setting->value : NULL; @endphp
                        ...
                        @elseif($setting->type == "checkbox")
                            @php $options = json_decode($setting->details); @endphp
                            @php $checked = (isset($setting->value) && $setting->value == 1) ? true : false; @endphp
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="{{ route('voyager.settings.delete', ['id' => '__id']) }}" id="delete_form"
                          method="POST">
                        {{ method_field("DELETE") }}
                        {{ csrf_field() }}
