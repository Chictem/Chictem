...
@section('content')
    <div class="page-content">
        <div class="widgets">
            <?php if (Illuminate\Support\Facades\Schema::hasTable(with(new App\Models\User())->getTable())) { ?>
            ...
            <?php } ?>
            <?php if (Illuminate\Support\Facades\Schema::hasTable(with(new App\Models\Post())->getTable())) { ?>
            <div class="panel widget center bgimage" style="background-image:url({{ config('voyager.assets_path') }}/images/widget-backgrounds/03.png);">
                ...
                <div class="panel-content">
                    ...
                    <?php $post_count = App\Models\Post::count(); ?>
            ...
            <?php } ?>
            <?php if (Illuminate\Support\Facades\Schema::hasTable(with(new App\Models\Page())->getTable())) { ?>
            <div class="panel widget center bgimage" style="background-image:url({{ config('voyager.assets_path') }}/images/widget-backgrounds/04.png);">
                ...
                <div class="panel-content">
                    ...
                    <?php $page_count = App\Models\Page::count(); ?>
