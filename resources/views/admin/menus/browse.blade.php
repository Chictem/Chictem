...
@section('content')
    <div class="container-fluid">
        <div class="alert alert-info">
            <p>{!! trans('admin.menu.message.use', ['usage' => "<code>Menu::display('name')</code>"]) !!} </p>
        </div>
    </div>
                            ...
                            @foreach($dataTypeContent as $data)
                                <tr>
                                    ...
                                    <td class="no-sort no-click">
                                        ...
                                        <a href="{{ route('voyager.'.$dataType->slug.'.builder', $data->id) }}"
                                           class="btn-sm btn-success pull-right">
                                            <i class="voyager-list"></i> {{ trans('common.button.build') }}
                                        </a>
                                    </td>
                                </tr>
                            @endforeach
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">
                        <i class="voyager-trash"></i> {{ trans('common.alert.delete', ['name' => trans('common.model.menu')]) }}
