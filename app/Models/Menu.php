...
class Menu extends Model
{
	...
	public static function buildAdminOutput($menuItems, $output, $options, $child = null)
	{
		...
		foreach ($parentItems as $item) {
			...
			$output .= '<div class="btn-sm btn-danger pull-right delete" data-id="' . $item->id . '"><i class="voyager-trash"></i> ' . trans('common.button.delete') . '</div>';
			$output .= '<div class="btn-sm btn-primary pull-right edit" data-id="' . $item->id . '" data-title="' . $item->title . '" data-url="' . $item->url . '" data-target="' . $item->target . '" data-icon_class="' . $item->icon_class . '" data-color="' . $item->color . '"><i class="voyager-edit"></i> ' . trans('common.button.edit') . '</div>';
			$output .= '</div>';
