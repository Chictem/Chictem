	...
	Route::group(['middleware' => ['admin.user']], function () {
		...
		try {
			foreach (DataType::all() as $dataType) {
				Route::resource($dataType->slug, 'VoyagerBreadController');
			}
		...
		Route::group([
			'as' => 'banners.',
			'prefix' => 'banners/{banner}',
		], function () {
			Route::get('builder', ['uses' => 'VoyagerBannerController@builder', 'as' => 'builder']);
			Route::post('order', ['uses' => 'VoyagerBannerController@order_item', 'as' => 'order']);

			Route::group([
				'as' => 'item.',
				'prefix' => 'item',
			], function () {
				Route::delete('{id}', ['uses' => 'VoyagerBannerController@delete_banner', 'as' => 'destroy']);
				Route::post('/', ['uses' => 'VoyagerBannerController@add_item', 'as' => 'add']);
				Route::put('/', ['uses' => 'VoyagerBannerController@update_item', 'as' => 'update']);
			});
		});
		...
		Route::group([
			...
			Route::get('{id}/delete_value', [
				'uses' => 'VoyagerSettingsController@delete_value',
				'as' => 'delete_value'
			]);
		});
